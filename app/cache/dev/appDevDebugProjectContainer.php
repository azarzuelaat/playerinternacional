...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->parameters = array(
            ...
            'player.path' => 'http://static1.tele-cinco.net/comun/swf',
            'app.backup.dir' => '/BACKUP/mediasat/',
            'mailto' => 'cincomas@mediaset.es',
            'pixelurl' => 'http://stats.telecinco.es/msatu.gif',
            'locale' => 'es',
            'allow_locales' => array(
                'spanish' => 'es',
                'english' => 'en',
            ),
            'secret' => 'a46e331ccf5fa079f9845ce641e7240b3da731f2',
            ...
            'kernel.secret' => 'a46e331ccf5fa079f9845ce641e7240b3da731f2',
            ...
            'twig.form.resources' => array(
                ...
                2 => 'TrsteelCkeditorBundle:Form:ckeditor_widget.html.twig',
            ),
            ...
            'trsteel_ckeditor.html_purifier.config' => array(
                'Cache.SerializerPath' => __DIR__,
            ),
            ...
            'trsteel_ckeditor.ckeditor.enter_mode' => NULL,
            'trsteel_ckeditor.ckeditor.external_plugins' => array(

            ),
            'trsteel_ckeditor.ckeditor.custom_config' => NULL,
            'trsteel_ckeditor.ckeditor.templates_files' => array(

            ),
            'trsteel_ckeditor.ckeditor.extra_allowed_content' => NULL,
            'app.promos' => array(

            ),
            'app.players' => array(
                'internacional' => array(
                    'url' => 'http://static1.tele-cinco.net/comun/swf/playerTele5.swf?1822222793',
            ...
            'app.promos.manager.class' => 'AppBundle\\Service\\PromosProvider',
            'app.user.manager.class' => 'AppBundle\\Service\\UserManager',
            'app.legal.manager.class' => 'AppBundle\\Service\\LegalManager',
            'app.backup.manager.class' => 'AppBundle\\Service\\BackupManager',
            'promos.path' => (dirname(dirname(__DIR__)).'/../web/images/promos'),
            'app.player.provider.class' => 'AppBundle\\Service\\PlayerProvider',
            'app.cache.listener.class' => 'AppBundle\\Service\\AcmeCacheListener',
        ...
        $this->methodMap = array(
            ...
            'app.backup.manager' => 'getApp_Backup_ManagerService',
            'app.cache.listener' => 'getApp_Cache_ListenerService',
            'app.legal.manager' => 'getApp_Legal_ManagerService',
            'app.player.provider' => 'getApp_Player_ProviderService',
            'app.promos.manager' => 'getApp_Promos_ManagerService',
    ...
    /**
     * Gets the 'app.backup.manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\BackupManager A AppBundle\Service\BackupManager instance.
     */
    protected function getApp_Backup_ManagerService()
    {
        return $this->services['app.backup.manager'] = new \AppBundle\Service\BackupManager($this->get('templating'), array('backupDir' => '/BACKUP/mediasat/', 'databasePath' => NULL, 'promosPath' => (dirname(dirname(__DIR__)).'/../web/images/promos')));
    }

    /**
     * Gets the 'app.cache.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\AcmeCacheListener A AppBundle\Service\AcmeCacheListener instance.
     */
    protected function getApp_Cache_ListenerService()
    {
        return $this->services['app.cache.listener'] = new \AppBundle\Service\AcmeCacheListener();
    }

    /**
     * Gets the 'app.legal.manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\LegalManager A AppBundle\Service\LegalManager instance.
     */
    protected function getApp_Legal_ManagerService()
    {
        return $this->services['app.legal.manager'] = new \AppBundle\Service\LegalManager($this->get('doctrine.orm.default_entity_manager'), $this->get('app.backup.manager'));
    }

    /**
     * Gets the 'app.player.provider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\PlayerProvider A AppBundle\Service\PlayerProvider instance.
     */
    protected function getApp_Player_ProviderService()
    {
        $this->services['app.player.provider'] = $instance = new \AppBundle\Service\PlayerProvider(array('internacional' => array('url' => 'http://static1.tele-cinco.net/comun/swf/playerTele5.swf?1822222793', 'background' => 'images/cartela.jpg', 'autoplay' => 'true', 'title' => 'mediasat', 'subtitle' => 'mediasat', 'scrubbing' => 'false', 'rtmp' => 'true', 'channel' => 'internacional')));
    ...
    /**
     * Gets the 'app.promos.manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\PromosProvider A AppBundle\Service\PromosProvider instance.
     */
    protected function getApp_Promos_ManagerService()
    {
        $this->services['app.promos.manager'] = $instance = new \AppBundle\Service\PromosProvider(array('internacional' => array('url' => 'http://static1.tele-cinco.net/comun/swf/playerTele5.swf?1822222793', 'background' => 'images/cartela.jpg', 'autoplay' => 'true', 'title' => 'mediasat', 'subtitle' => 'mediasat', 'scrubbing' => 'false', 'rtmp' => 'true', 'channel' => 'internacional')));

        $instance->setRouter($this->get('router'));
        $instance->setDoctrine($this->get('doctrine.orm.default_entity_manager'));
    ...
    /**
     * Gets the 'app.user.manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\UserManager A AppBundle\Service\UserManager instance.
     */
    protected function getApp_User_ManagerService()
    {
        return $this->services['app.user.manager'] = new \AppBundle\Service\UserManager($this->get('doctrine.orm.default_entity_manager'), $this->get('fos_user.user_manager'), $this->get('security.encoder_factory'));
    }
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\ConfigurationResource(array('estilos' => array(0 => array(0 => 'bundles/app/css/reset.css', 1 => 'bundles/app/css/estilos.css', 2 => 'bundles/app/css/parrilla.css', 3 => 'bundles/app/css/form.css'), 1 => array(), 2 => array()), 'javascript' => array(0 => array(0 => 'bundles/app/js/jquery.min.js', 1 => 'bundles/app/js/jquery-ui.min.js', 2 => 'bundles/app/js/jquery.cookie.min.js', 3 => 'bundles/app/js/app.js'), 1 => array(), 2 => array()))), 'config');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AppBundle', (dirname(dirname(__DIR__)).'/Resources/AppBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AppBundle', (dirname(dirname(dirname(__DIR__))).'/src/AppBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.response', array(0 => 'app.cache.listener', 1 => 'onKernelResponse'), 0);
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addEventSubscriber($this->get('stof_doctrine_extensions.listener.translatable'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'mediaset', 'user' => 'root', 'password' => 1234, 'path' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_f68e0a4ddcf5c269c9ce390c8aefdb982126190862c4169d4bb85bc40a5a30d0');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_f68e0a4ddcf5c269c9ce390c8aefdb982126190862c4169d4bb85bc40a5a30d0');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_f68e0a4ddcf5c269c9ce390c8aefdb982126190862c4169d4bb85bc40a5a30d0');

        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => (dirname(dirname(dirname(__DIR__))).'/vendor/gedmo/doctrine-extensions/lib/Gedmo/Translatable/Entity'), 1 => (dirname(dirname(dirname(__DIR__))).'/src/AppBundle/Entity')));

        $f = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $f->addDriver($e, 'Gedmo\\Translatable\\Entity');
        $f->addDriver($e, 'AppBundle\\Entity');
        $f->addDriver(new \Doctrine\ORM\Mapping\Driver\XmlDriver(new \Doctrine\Common\Persistence\Mapping\Driver\SymfonyFileLocator(array((dirname(dirname(dirname(__DIR__))).'/vendor/friendsofsymfony/user-bundle/Resources/config/doctrine/model') => 'FOS\\UserBundle\\Model'), '.orm.xml')), 'FOS\\UserBundle\\Model');

        $g = new \Doctrine\ORM\Configuration();
        $g->setEntityNamespaces(array('GedmoTranslatable' => 'Gedmo\\Translatable\\Entity', 'AppBundle' => 'AppBundle\\Entity'));
    ...
    {
        return $this->services['jms_i18n_routing.loader'] = new \JMS\I18nRoutingBundle\Router\I18nLoader(new \JMS\I18nRoutingBundle\Router\DefaultRouteExclusionStrategy(), new \JMS\I18nRoutingBundle\Router\DefaultPatternGenerationStrategy('prefix', $this->get('translator'), array('spanish' => 'es', 'english' => 'en'), __DIR__, 'routes', 'es'));
    }
    ...
    {
        return $this->services['jms_i18n_routing.locale_choosing_listener'] = new \JMS\I18nRoutingBundle\EventListener\LocaleChoosingListener('es', array('spanish' => 'es', 'english' => 'en'), $this->get('jms_i18n_routing.locale_resolver.default'));
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler((dirname(dirname(__DIR__)).'/logs/dev.log'), 250, true);
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/[^/]+/promos');

        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/[^/]+/stats');

        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/[^/]+/legal');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/[^/]+/view');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/[^/]+/parrilla');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/[^/]+/corporate');

        $n = new \Symfony\Component\HttpFoundation\RequestMatcher('^/[^/]+/live');

        $o = new \Symfony\Component\HttpFoundation\RequestMatcher('^/[^/]+/users');
        ...
        $q = new \Symfony\Component\Security\Core\User\InMemoryUserProvider();
        $q->createUser(new \Symfony\Component\Security\Core\User\User('user', 'userpass', array(0 => 'ROLE_USER')));
        $q->createUser(new \Symfony\Component\Security\Core\User\User('admin', 'adminpass', array(0 => 'ROLE_ADMIN')));

        $r = new \Symfony\Component\Security\Http\HttpUtils($d, $d);

        $s = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $r, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($r, '/'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'fos_user_security_logout'));
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($p, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $q, 1 => $this->get('fos_user.user_provider.username_email')), 'main', $a, $c), 2 => $s, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, $this->get('security.authentication.session_strategy'), $r, 'main', $t, $u, array('check_path' => 'fos_user_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, $this->get('form.csrf_provider')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '5c4995cf683e5', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $p, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $r, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $r, 'fos_user_security_login', false), NULL, NULL, $a));
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('yml', (dirname(dirname(__DIR__)).'/Resources/FOSUserBundle/translations/FOSUserBundle.es.yml'), 'es', 'FOSUserBundle');
        $instance->addResource('xliff', (dirname(dirname(dirname(__DIR__))).'/vendor/white-october/pagerfanta-bundle/WhiteOctober/PagerfantaBundle/Resources/translations/pagerfanta.de.xliff'), 'de', 'pagerfanta');
        $instance->addResource('xliff', (dirname(dirname(dirname(__DIR__))).'/vendor/white-october/pagerfanta-bundle/WhiteOctober/PagerfantaBundle/Resources/translations/pagerfanta.pl.xliff'), 'pl', 'pagerfanta');
        $instance->addResource('xliff', (dirname(dirname(dirname(__DIR__))).'/vendor/white-october/pagerfanta-bundle/WhiteOctober/PagerfantaBundle/Resources/translations/pagerfanta.fr.xliff'), 'fr', 'pagerfanta');
        $instance->addResource('xliff', (dirname(dirname(dirname(__DIR__))).'/vendor/white-october/pagerfanta-bundle/WhiteOctober/PagerfantaBundle/Resources/translations/pagerfanta.it.xliff'), 'it', 'pagerfanta');
        $instance->addResource('xliff', (dirname(dirname(dirname(__DIR__))).'/vendor/white-october/pagerfanta-bundle/WhiteOctober/PagerfantaBundle/Resources/translations/pagerfanta.ru.xliff'), 'ru', 'pagerfanta');
        $instance->addResource('xliff', (dirname(dirname(dirname(__DIR__))).'/vendor/white-october/pagerfanta-bundle/WhiteOctober/PagerfantaBundle/Resources/translations/pagerfanta.sr_Cyrl.xliff'), 'sr_Cyrl', 'pagerfanta');
        $instance->addResource('xliff', (dirname(dirname(dirname(__DIR__))).'/vendor/white-october/pagerfanta-bundle/WhiteOctober/PagerfantaBundle/Resources/translations/pagerfanta.ar.xliff'), 'ar', 'pagerfanta');
        $instance->addResource('xliff', (dirname(dirname(dirname(__DIR__))).'/vendor/white-october/pagerfanta-bundle/WhiteOctober/PagerfantaBundle/Resources/translations/pagerfanta.es.xliff'), 'es', 'pagerfanta');
        $instance->addResource('xliff', (dirname(dirname(dirname(__DIR__))).'/vendor/white-october/pagerfanta-bundle/WhiteOctober/PagerfantaBundle/Resources/translations/pagerfanta.pt.xliff'), 'pt', 'pagerfanta');
        $instance->addResource('xliff', (dirname(dirname(dirname(__DIR__))).'/vendor/white-october/pagerfanta-bundle/WhiteOctober/PagerfantaBundle/Resources/translations/pagerfanta.nl.xliff'), 'nl', 'pagerfanta');
        $instance->addResource('xliff', (dirname(dirname(dirname(__DIR__))).'/vendor/white-october/pagerfanta-bundle/WhiteOctober/PagerfantaBundle/Resources/translations/pagerfanta.sr_Latn.xliff'), 'sr_Latn', 'pagerfanta');
        $instance->addResource('xliff', (dirname(dirname(dirname(__DIR__))).'/vendor/white-october/pagerfanta-bundle/WhiteOctober/PagerfantaBundle/Resources/translations/pagerfanta.tr.xliff'), 'tr', 'pagerfanta');
        $instance->addResource('xliff', (dirname(dirname(dirname(__DIR__))).'/vendor/white-october/pagerfanta-bundle/WhiteOctober/PagerfantaBundle/Resources/translations/pagerfanta.en.xliff'), 'en', 'pagerfanta');
        $instance->addResource('xliff', (dirname(dirname(dirname(__DIR__))).'/vendor/white-october/pagerfanta-bundle/WhiteOctober/PagerfantaBundle/Resources/translations/pagerfanta.az.xliff'), 'az', 'pagerfanta');
        $instance->addResource('xliff', (dirname(dirname(dirname(__DIR__))).'/vendor/white-october/pagerfanta-bundle/WhiteOctober/PagerfantaBundle/Resources/translations/pagerfanta.cs.xliff'), 'cs', 'pagerfanta');
        $instance->addResource('xliff', (dirname(dirname(dirname(__DIR__))).'/vendor/white-october/pagerfanta-bundle/WhiteOctober/PagerfantaBundle/Resources/translations/pagerfanta.zh_CN.xliff'), 'zh_CN', 'pagerfanta');
        $instance->addResource('xliff', (dirname(dirname(dirname(__DIR__))).'/vendor/white-october/pagerfanta-bundle/WhiteOctober/PagerfantaBundle/Resources/translations/pagerfanta.ca.xliff'), 'ca', 'pagerfanta');
        $instance->addResource('xliff', (dirname(dirname(dirname(__DIR__))).'/vendor/white-october/pagerfanta-bundle/WhiteOctober/PagerfantaBundle/Resources/translations/pagerfanta.da.xliff'), 'da', 'pagerfanta');
        $instance->addResource('yml', (dirname(dirname(__DIR__)).'/Resources/translations/legal.en.yml'), 'en', 'legal');
        $instance->addResource('yml', (dirname(dirname(__DIR__)).'/Resources/translations/legal.es.yml'), 'es', 'legal');
        $instance->addResource('xlf', (dirname(dirname(__DIR__)).'/Resources/translations/security.es.xlf'), 'es', 'security');
        $instance->addResource('yml', (dirname(dirname(__DIR__)).'/Resources/translations/messages.es.yml'), 'es', 'messages');
        $instance->addResource('xlf', (dirname(dirname(__DIR__)).'/Resources/translations/security.en.xlf'), 'en', 'security');
        $instance->addResource('yml', (dirname(dirname(__DIR__)).'/Resources/translations/messages.en.yml'), 'en', 'messages');
    ...
    protected function getTrsteelCkeditor_Form_TypeService()
    {
        ...
        $instance->addTransformer(new \Trsteel\CkeditorBundle\Form\DataTransformer\HTMLPurifierTransformer(array('Cache.SerializerPath' => __DIR__)), 'html_purifier');
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'form_themes' => array(0 => 'form_div_layout.html.twig', 1 => 'AppBundle:Form:fields.html.twig'), 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'form_div_layout.html.twig', 1 => 'AppBundle:Form:fields.html.twig', 2 => 'TrsteelCkeditorBundle:Form:ckeditor_widget.html.twig')), $this->get('form.csrf_provider', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
        $instance->addExtension(new \Twig_Extension_Debug());
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'AppBundle'), $this->get('assetic.value_supplier.default', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
        ...
        $instance->addGlobal('locales', array('spanish' => 'es', 'english' => 'en'));
        $instance->addGlobal('mailto', 'cincomas@mediaset.es');
        $instance->addGlobal('pixelUrl', 'http://stats.telecinco.es/msatu.gif');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath((dirname(dirname(__DIR__)).'/Resources/TwigBundle/views'), 'Twig');
        ...
        $instance->addPath((dirname(dirname(__DIR__)).'/Resources/FOSUserBundle/views'), 'FOSUser');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/vendor/friendsofsymfony/user-bundle/Resources/views'), 'FOSUser');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/vendor/trsteel/ckeditor-bundle/Trsteel/CkeditorBundle/Resources/views'), 'TrsteelCkeditor');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('a46e331ccf5fa079f9845ce641e7240b3da731f2');
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $b = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ADMIN' => array(0 => 'ROLE_USER'), 'ROLE_SUPERADMIN' => array(0 => 'ROLE_ADMIN')));
    ...
    protected function getStofDoctrineExtensions_Listener_TranslatableService()
    {
        ...
        $instance->setDefaultLocale('es');
        $instance->setTranslatableLocale('es');
